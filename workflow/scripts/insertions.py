...
print("# of processors:", num_processors)
...
if both:
    ...
    print("No germinal insertion detection will be performed.")
    print("To detect germline insertion use the GRID bsed approach.")
